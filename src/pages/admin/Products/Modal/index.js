...
import { handleAddNewColor, handleChangeInputText } from "~/redux/slices/productSlice";
...
function Modal({ setModal, typeModal, getAllProducts, getAllProductCaterogies, filter , listProductCategory}) {
