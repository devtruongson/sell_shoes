                            ...
                            return (
                                <div key={index} style={{ margin: "0 10px" }}>
                                    <VoucherItem
                                        ...
                                        voucherDes={item.description}
                                        voucherOutDate={convertDate(
                                            item.expiredDate
                                        )}
                                    />
                                </div>
            ...
            <Link to={"/user-profile/info"}>
                <label for={closeBtn}>
                    <div className={cx("btnToProfile")}>
                        <span className={cx("textToProfile")}>
                            Đi đến tài khoản
                        </span>
                    </div>
                </label>
