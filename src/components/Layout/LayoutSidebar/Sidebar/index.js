...
import { MdOutlineAnalytics, MdOutlineRateReview, MdPages } from "react-icons/md";
        ...
        >
            ...
            <div className="d-flex nav nav-pills flex-column mb-auto pt-2">
                <div className={cx("sidebar-item")}>
                    <Link
                        to={"/admin"}
                        className={cx(`sidebar-item-link`, {
                ...
                <div className={cx("sidebar-item")}>
                    <Link
                        to={"/admin/vouchers-manage"}
                        className={cx("sidebar-item-link", {
                            "active-item": activeItem === "Vouchers",
                        })}
                        onClick={() => {
                            handleClickItem("Vouchers");
                        }}
                    >
                ...
                <div className={cx("sidebar-item")}>
                    <Link
                        to={"/admin/footer"}
                        className={cx("sidebar-item-link", {
                            "active-item": activeItem === "Footer",
                        })}
                        onClick={() => {
                            handleClickItem("Footer");
                        }}
                    >
                        <FaPager className={cx("sidebar-icon")} />
                        <div>Footer</div>
                    </Link>
                </div>
                <div className={cx("sidebar-item")}>
                    <Link
                        to={"/admin/categories"}
                        className={cx("sidebar-item-link", {
                            "active-item": activeItem === "cate",
                        })}
                        onClick={() => {
                            handleClickItem("cate");
                        }}
                    >
                        <MdPages className={cx("sidebar-icon")} />
                        <div>Categories</div>
                    </Link>
                </div>
                <div className={cx("sidebar-item")}>
                    <Link
                        to={"/admin/type-product"}
                        className={cx("sidebar-item-link", {
                            "active-item": activeItem === "productType",
                        })}
                        onClick={() => {
                            handleClickItem("productType");
                        }}
                    >
                        <SiPagespeedinsights className={cx("sidebar-icon")} />
            ...
            <div>
                <div className="d-flex align-items-center text-white text-decoration-none ">
                    <img
                        src="https://static.vecteezy.com/system/resources/thumbnails/000/290/610/small_2x/10__2850_29.jpg"
                        alt=""
                        width="32"
                        height="32"
