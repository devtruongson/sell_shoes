...
import { CustomerManage, VouchersAdmin } from "~/pages/admin";
import Cate from "~/pages/admin/cate/cate";
...
import ProductType from "~/pages/admin/product_type/ProductType";
...
export const adminRoutes = [
    ...
    {
        path: "/admin/history/import",
        component: RentalImport,
        layout: LayoutSidebar,
    },
    {
        path: "/admin/faq",
